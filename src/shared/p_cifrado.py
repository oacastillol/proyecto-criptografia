# Modulo encargado de generar las llaves, tomando comopartida la llave
# dada por el usuario.
...
# Bloques, etapa intermedia, si es "l" o "r" --corta en la mitad y toma la
...
def pcifrado(lista_m, key):
    ...
    while rango <= rango_m:
        ...
        # En dado caso que la key tenga mas de 8 bytes solo toma encuenta los
        # primeros 8
        list2 = c_relleno(key)
        #list2 = c_relleno(key)
